...
def load_and_filter_xlsx_knownissues(xlsx_path, sheet_id, sheet_gid):
    """
    Load XLSX file, merge in google sheet issue text, filter to autoparsed
    rows, fill missing values, and strip whitespace.
    """
...
def load_and_filter_xlsx_resolved(xlsx_path, sheet_id, sheet_gid, domain_mapping):
    """
    Load XLSX file, merge in google sheet issue text, filter to items ready
    to archive, remap domain values, fill missing values, and strip whitespace.
    """
