...
!!! danger "NOTE: Items Are Provisional"
    These items will remain listed under <a href="../../knownissues/" target="_blank">active issues/updates</a> until final Workgroup/SME confirmation that the resolution has been successfully implemented (also see <a href="../../resolved/" target="_blank">this page</a> for a running record of confirmed resolved items starting at BR21.0).
    
    

<!-- <div id="warning" class="alert-banner" onclick="toggleCollapse(this)">
  <span class="emoji"><i class="fas fa-exclamation-triangle"></i></span>
  <span class="text">Note: items are <i>provisional</i> and will remain listed as  until final Workgroups/SME signoff.</span>
</div> -->
