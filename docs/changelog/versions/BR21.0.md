...
<div id="warning" class="alert-banner" onclick="toggleCollapse(this)">
  ...
  <span class="text">Note: items are <i>provisional</i> and will remain listed as <a href="../../knownissues/" target="_blank">active issues/updates</a> until final Workgroups/SME signoff.</span>
</div>
