...
!!! info "Note: Status is Tentative"
    These items will remain listed under [Known Issues & Pending Updates](../knownissues.md) until final confirmation by the relevant Workgroup/SME that the resolution has been successfully implemented.
