...
#### Demographics
* **Basic Demographics - 'Recruitment Site'**
    * Excluded selected sites from 'Recruitment site' (Similar to 'Visit Data' but for 'Basic Demographics')
    * Excluded sites: 2 ("BAH"), 9 ("Data Coordinating Center"), 18 ("Sampled"), 19 ("Test Site"), 31 ("USDTL")
    * <span style="color: red;">why do these values differ from what is displayed in levels table?</span>
* **Visit Data - Rollover SU Flags** - Ensure rollover SU flags are cumulative  

#### Behavior & Child-Caregiver Interaction
* **ERICA Reliability** - Removed `mh_cg_erica_rel_3_9m_lang` field from ERICA Reliability  
    * <span style="color: red;">what about date taken and age fields?</span>
...
- **SPM2 - Missing T-Scores** - Added missing T-score fields  
    - Pending to move 'text' in score fields to separate 'notes fields (to be done for 3.0)  
...
* **APA** - Level-2 data removed when Level-1 criteria was not met across all sub-scales except 'Depression' subscale (Level-2 always administered and criteria removed)  
    * <span style="color: red;">other level-2 subscales are also administered as well, e.g. Somatic - did those just not have this issue and that's why Depression is mentioned here specifically?</span>

##### Physical Health
* **ecPROMIS PAGS/Sleep** - Added score fields, including corresponding 'notes' fields:
    * *ph_cg_pms_pags_total_score*  
    * *ph_cg_pms_pags_t_score*  
    * *ph_cg_pms_pags_se_score*
    * <span style="color: red;">why does this say 'Sleep?'</span>
