...
flowchart LR
 ...
 subgraph Capture_LORIS["Sites Capture<br><a href="../../orgcharts/#loris"><b>LORIS</b></a>"]
        n12[/"EEG BIDSWizard"/]
        n13[/"Axtivity"/]
        n14[/"GABI"/]
  end
    ...
    UMN --> JCVI
    JCVI --> n1
    n1 --> RAW_BIDS["<b>S3 MAIN PR<br></b><i>s3://midb-hbcd-main-pr/assembly_bids/</i>"]
    n6 --> n9 & n10
    n9 --> n10
    n10 --> n11
    n11 --> RAW_BIDS
